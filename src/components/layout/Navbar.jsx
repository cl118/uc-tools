...
const Navbar = () => {
  ...
  return (
    <div className='w-full h-12 shadow-md px-4 bg-white'>
      <div className='max-w-[1440px] mx-auto flex h-full justify-between items-center'>
        <div className='flex items-center'>
          <a href='/'><h1 className='text-[#011F5B] text-2xl font-bold'>LGH UC TOOLS</h1></a>
        </div>
        <div className='flex gap-4 items-center'>
          {username !== null ? <><p>Welcome, {firstName}</p>
            <p>|</p></> : null}
          <a
            href='/account'
            className='font-semibold hover:text-gray-400 hover:border-b-2 border-gray-400'
          >
            Account
          </a>
          {isAuthenticated ? (
